...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg border border-slate-200 shadow-sm overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-slate-200 bg-slate-50 flex justify-between items-center">
            <h3 class="text-sm font-bold text-slate-800 uppercase font-mono tracking-wider">Formulir Edit User: {{ $userModel->name }}</h3>
        ...
        <form action="{{ route('users.update', $userModel->id) }}" method="POST" class="p-6 space-y-5">
            ...
            <div class="bg-slate-50 p-4 rounded border border-slate-200">
                <span class="block text-xs font-mono font-bold text-slate-600 mb-2">Ganti Password (Opsional)</span>
                <!-- Password Grid -->
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-xs font-bold uppercase tracking-wider text-slate-650 mb-1">Password Baru</label>
                    ...
                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="block text-xs font-bold uppercase tracking-wider text-slate-650 mb-1">Konfirmasi Password Baru</label>
