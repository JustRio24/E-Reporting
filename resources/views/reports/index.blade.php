...
<div class="space-y-6">
    <!-- Filter Panel -->
    <div class="bg-gradient-to-br from-slate-900/80 via-blue-900/40 to-yellow-600/10 backdrop-blur-md p-6 rounded-lg border border-slate-700/50 shadow-sm transition-all duration-500 hover:border-yellow-500/30 hover:shadow-lg hover:shadow-yellow-500/5">
        ...
        <form action="{{ route('reports.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-5 gap-4">
            <!-- Start Date -->
            <div>
                <label for="start_date" class="block text-3xs font-mono font-bold uppercase text-blue-200 mb-1">Tanggal Mulai</label>
            ...
            <!-- End Date -->
            <div>
                <label for="end_date" class="block text-3xs font-mono font-bold uppercase text-blue-200 mb-1">Tanggal Selesai</label>
            ...
            <!-- Facility -->
            <div>
                <label for="facility_id" class="block text-3xs font-mono font-bold uppercase text-blue-200 mb-1">Fasilitas</label>
            ...
            <!-- Status -->
            <div>
                <label for="status" class="block text-3xs font-mono font-bold uppercase text-blue-200 mb-1">Status Laporan</label>
            ...
            <!-- Severity -->
            <div>
                <label for="severity" class="block text-3xs font-mono font-bold uppercase text-blue-200 mb-1">Tingkat Keparahan</label>
            ...
            <div class="md:col-span-5 flex justify-end gap-3 pt-3 border-t border-slate-100">
                <a href="{{ route('reports.index') }}" class="bg-slate-150 text-slate-300 text-xs font-semibold px-4 py-2.5 rounded hover:bg-slate-200">
                    Reset Filter
                </a>
    ...
    <div class="bg-gradient-to-br from-slate-900/80 via-blue-900/40 to-yellow-600/10 backdrop-blur-md rounded-lg border border-slate-700/50 shadow-sm overflow-hidden transition-all duration-500 hover:border-yellow-500/30 hover:shadow-lg hover:shadow-yellow-500/5">
        <div class="px-5 py-4 border-b border-slate-700/50 bg-slate-900/40 flex justify-between items-center">
                ...
                <tbody class="divide-y divide-slate-700/50 text-xs">
                    @forelse($reports as $rep)
                        <tr class="hover:bg-slate-700/30 transition-colors">
                            <td class="py-3.5 px-4 font-mono font-bold text-white select-all">{{ $rep->report_number }}</td>
                            ...
                            <td class="py-3.5 px-4">
                                ...
                                <span class="block text-4xs font-mono text-blue-200 mt-0.5">{{ $rep->facility->facility_code }}</span>
                            </td>
                            <td class="py-3.5 px-4 text-slate-300 leading-normal">{{ $rep->title }}</td>
